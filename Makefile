...
cleanrun:
	${DOCKER_COMPOSE} -f ${DOCKER_ENVIRONMENT} up --remove-orphans
...
# target: createsuperuser - Create a superuser for django-admin
collectstatic:
	${PRE_RUN_API_COMMAND} collectstatic
...
# target: makemessages - Create the migrations of the database
.PHONY: makemessages
makemessages:
	${PRE_RUN_API_COMMAND} makemessages
